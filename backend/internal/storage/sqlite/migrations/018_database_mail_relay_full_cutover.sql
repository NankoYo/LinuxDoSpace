...
ALTER TABLE email_targets ADD COLUMN verification_token_hash TEXT NOT NULL DEFAULT '';
ALTER TABLE email_targets ADD COLUMN verification_expires_at TEXT NULL;
